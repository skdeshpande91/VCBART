...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(vc_BART_ar(Y, X_train, Z_train, n_vec_train, start_index_vec_train, X_test, Z_test, n_vec_test, start_index_vec_test, xinfo_list, m, sigma_mu_vec, alpha_vec, beta_vec, burn, nd, rho, sigma_hat, ht_sigma_y, ht_sigma_mu, nu_sigma, nu_sigma_mu, variance_prob, verbose, print_every));
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< bool >::type verbose(verboseSEXP);
    Rcpp::traits::input_parameter< size_t >::type print_every(print_everySEXP);
    rcpp_result_gen = Rcpp::wrap(vc_BART_cs(Y, X_train, Z_train, n_vec_train, start_index_vec_train, X_test, Z_test, n_vec_test, start_index_vec_test, xinfo_list, m, sigma_mu_vec, alpha_vec, beta_vec, burn, nd, rho, sigma_hat, ht_sigma_y, ht_sigma_mu, nu_sigma, nu_sigma_mu, variance_prob, verbose, print_every));
    return rcpp_result_gen;
END_RCPP
}
// vc_BART_ind
Rcpp::List vc_BART_ind(arma::vec Y, arma::mat X_train, arma::mat Z_train, arma::vec n_vec_train, arma::vec start_index_vec_train, arma::mat X_test, arma::mat Z_test, arma::vec n_vec_test, arma::vec start_index_vec_test, Rcpp::List xinfo_list, size_t m, arma::vec sigma_mu_vec, arma::vec alpha_vec, arma::vec beta_vec, size_t burn, size_t nd, double sigma_hat, bool ht_sigma_y, bool ht_sigma_mu, double nu_sigma, double nu_sigma_mu, double variance_prob, bool verbose, size_t print_every);
RcppExport SEXP _VCBART_vc_BART_ind(SEXP YSEXP, SEXP X_trainSEXP, SEXP Z_trainSEXP, SEXP n_vec_trainSEXP, SEXP start_index_vec_trainSEXP, SEXP X_testSEXP, SEXP Z_testSEXP, SEXP n_vec_testSEXP, SEXP start_index_vec_testSEXP, SEXP xinfo_listSEXP, SEXP mSEXP, SEXP sigma_mu_vecSEXP, SEXP alpha_vecSEXP, SEXP beta_vecSEXP, SEXP burnSEXP, SEXP ndSEXP, SEXP sigma_hatSEXP, SEXP ht_sigma_ySEXP, SEXP ht_sigma_muSEXP, SEXP nu_sigmaSEXP, SEXP nu_sigma_muSEXP, SEXP variance_probSEXP, SEXP verboseSEXP, SEXP print_everySEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::vec >::type Y(YSEXP);
    ...
    Rcpp::traits::input_parameter< bool >::type verbose(verboseSEXP);
    Rcpp::traits::input_parameter< size_t >::type print_every(print_everySEXP);
    rcpp_result_gen = Rcpp::wrap(vc_BART_ind(Y, X_train, Z_train, n_vec_train, start_index_vec_train, X_test, Z_test, n_vec_test, start_index_vec_test, xinfo_list, m, sigma_mu_vec, alpha_vec, beta_vec, burn, nd, sigma_hat, ht_sigma_y, ht_sigma_mu, nu_sigma, nu_sigma_mu, variance_prob, verbose, print_every));
    return rcpp_result_gen;
END_RCPP
}
