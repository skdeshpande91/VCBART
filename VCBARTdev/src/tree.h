...
public:
  ...
  friend void update_tree_ind(tree &x, double &sigma, std::vector<double> &theta, std::vector<size_t> &var_counts, xinfo &xi, data_info &di, tree_prior_info &tree_pi, RNG &gen);
  friend void update_tree_cs(tree &x, double &sigma, double &rho_eps, std::vector<double> &theta, std::vector<size_t> &var_counts, xinfo &xi, data_info &di, tree_prior_info &tree_pi, RNG &gen);
