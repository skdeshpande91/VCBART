...
beta_mse_mean <- apply(beta_mse_test[["sigma1"]], FUN = mean, MARGIN = c(1,3))
beta_cov_mean <- apply(beta_cov_test[["sigma1"]], FUN = mean, MARGIN = c(1,3))
...
text(x = 0.5, y = 3, labels = "KS",cex = 0.85*par('cex'))
text(x = 5, y = 4, labels = "lm", cex = 0.85*par('cex'))
...
text(x = 0.65, y = 3, labels = "KS",cex = 0.85*par('cex'))
text(x = 0.65, y = 4, labels = "lm", cex = 0.85*par('cex'))
abline(v = 0.95, col = 'red', lty = 2)

par(mar = c(3, 1, 2, 1), mgp = c(1.8, 0.5, 0), cex.lab = 1, cex.axis = 1, cex.main = 1)
boxplot.matrix(ystar_rmse_test[["sigma1"]][,all_methods], use.cols = TRUE, horizontal = TRUE,
...
text(x = 6, y = 3, labels = "KS",cex = 0.85*par('cex'))
text(x = 5, y = 4, labels = "lm", cex = 0.85*par('cex'))
text(x = 6, y = 5, labels = "BART", cex = 0.85*par('cex'))
text(x = 6, y = 6, labels = "ERT", cex = 0.85*par('cex'))


par(mar = c(3, 1, 2, 1), mgp = c(1.8, 0.5, 0), cex.lab = 1, cex.axis = 1, cex.main = 1)
boxplot.matrix(ystar_cov_test[["sigma1"]][,all_methods], use.cols = TRUE, horizontal = TRUE,
...
text(x = 0.9, y = 3, labels = "KS",cex = 0.85*par('cex'))
text(x = 0.8, y = 4, labels = "lm", cex = 0.85*par('cex'))
text(x = 0.65, y = 5, labels = "BART", cex = 0.85*par('cex'))
text(x = 0.6, y = 6, labels = "ERT", cex = 0.85*par('cex'))
abline(v = 0.95, col = 'red', lty = 2)
