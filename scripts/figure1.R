...
png("~/Documents/Research/vc_bart/biometrics_submission/figures/p5R20_beta.png", 
...
polygon(c(Z_plot[plot0_ix1,1], rev(Z_plot[plot0_ix1,1])),
        ...
        col = rgb(0.5,0.5,0.5,1/3), border = NA)
lines(Z_plot[plot0_ix0,1], beta0_hat[plot0_ix0,"MEAN"], lwd = 1.25)
lines(Z_plot[plot0_ix1,1], beta0_hat[plot0_ix1,"MEAN"], lwd = 1.25, lty = 2)
...
polygon(c(Z_plot[plot1_ix,1], rev(Z_plot[plot1_ix,1])),
        ...
        col = rgb(0.5,0.5,0.5,1/3), border = NA)
lines(Z_plot[plot1_ix,1], beta1_hat[plot1_ix,"MEAN"], lwd = 1.25)
lines(Z_plot[plot1_ix,1], beta_plot[plot1_ix,2], lwd = 0.75)
...
polygon(c(Z_plot[plot2_ix2,1], rev(Z_plot[plot2_ix2,1])),
        ...
        col = rgb(0.5,0.5,0.5,1/3), border = NA)
lines(Z_plot[plot2_ix0,1], beta2_hat[plot2_ix0, "MEAN"], lwd = 1.25)
lines(Z_plot[plot2_ix1,1], beta2_hat[plot2_ix1, "MEAN"], lwd = 1.25)
lines(Z_plot[plot2_ix2,1], beta2_hat[plot2_ix2, "MEAN"], lwd = 1.25)
...
polygon(c(Z_plot[plot3_ix,1], rev(Z_plot[plot3_ix,1])),
        ...
        col = rgb(0.5,0.5,0.5,1/3), border = NA)
lines(Z_plot[plot3_ix,1], beta3_hat[plot3_ix,"MEAN"], lwd = 1.25)
lines(Z_plot[plot3_ix,1], beta_plot[plot3_ix,4], lwd = 0.75)
