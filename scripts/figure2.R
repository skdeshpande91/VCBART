...
png("~/Documents/Research/vc_bart/figures/p5R20_performance.png",
    width = 8, height = 8 * 2/3, units = "in", res = 300)
...
boxplot.matrix(beta_int_mean[lin_method_names,], use.cols = FALSE, horizontal = TRUE,
...
text(x = 2.5, y = 1, labels = expression("VC-BART"~(rho == 0)), cex = 0.95)
text(x = 2, y = 2, labels = expression("lm"), cex = 0.95)
text(x = 0.85, y = 3, labels = expression("KS"), cex = 0.95)
text(x = 0.85, y = 4, labels = expression("TVCM"), cex = 0.95)
...
text(x = 5, y = 1, labels = expression("VC-BART"~(rho == 0)), cex = 0.95)
text(x = 4, y = 2, labels = expression("lm"), cex = 0.95)
text(x = 3, y = 3, labels = expression("KS"), cex = 0.95)
text(x = 2.5, y = 4, labels = expression("TVCM"), cex = 0.95)
text(x = 2.5, y = 5, labels = expression("BTVCM"), cex = 0.95)
...
boxplot.matrix(ystar_int_test[method_names,], use.cols = FALSE, horizontal = TRUE,
               main = expression("Prediction interval length"), xlab = "", yaxt = "n",
               pch = 16, cex = 0.7, medlwd = 0.5, at = 1:8)
mtext(text = "Relative Length\n(f)", side = 1, line = 3, cex = 1.25 * par('cex'))
text(x = 2, y = 1, labels = expression("VC-BART"~(rho == 0)), cex = 0.95)
text(x = 2, y = 2, labels = expression("lm"), cex = 0.95)
text(x = 0.75, y = 3, labels = expression("KS"), cex = 0.95)
text(x = 3, y = 4, labels = expression("TVCM"), cex = 0.95)
text(x = 1, y = 5, labels = expression("BTVCM"), cex = 0.95)
text(x = 1, y = 6, labels = expression("BART"), cex = 0.95)
text(x = 1.5, y = 7, labels = expression("ERT"), cex = 0.95)
text(x = 3.2, y = 8.5, labels = expression("GBM"), cex = 0.95)
...
# Alternative figure
png("~/Documents/Research/vc_bart/figures/p5R20_performance_alt.png",
    width = 8, height = 2, units = "in", res = 400)
...
boxplot.matrix(ystar_rmse_test[method_names,], use.cols = FALSE, horizontal = TRUE,
               ...
               pch = 16, cex = 0.7, medlwd = 0.5, at = 1:8)
mtext(text = "RMSE\n(c)", side = 1, line = 3, cex = 1.25 * par('cex'))
text(x = 6, y = 1, labels = expression("VC-BART"~(rho == 0)), cex = 0.95)
text(x = 4, y = 2, labels = expression("lm"), cex = 0.95)
text(x = 3, y = 3, labels = expression("KS"), cex = 0.95)
